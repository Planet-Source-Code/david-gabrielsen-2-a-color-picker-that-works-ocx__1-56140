...
Private Sub LoadColors(brightness As Long)
    ...
    For i = 0 To 197 Step 1
        ...
        If pc(i).BackColor = lngDefaultColor Then
            selColIndex = i
            foundColor = True
        End If
        'pc(i).ToolTipText = "Hue : " & hue & ", Saturation : " & sat & vbCrLf & "Brightness : " & ClrMdl.brightness(ClrMdl.RGBToHSB(pc(i).BackColor))
        hue = col * 20
        sat = row * 10
    Next i
    ...
    Else
        UpdateTextValues lngDefaultColor
        FadeColor lngDefaultColor
    End If
End Sub
